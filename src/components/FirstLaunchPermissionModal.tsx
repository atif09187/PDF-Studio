    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm animate-in fade-in duration-200">
      ...
      >
        ...
        <p className="text-sm text-slate-300 leading-relaxed">
          To insert images from your device gallery and export PDF documents to your storage, PDF Studio requires permission access:
        </p>
        ...
        <div className="flex flex-col gap-2.5 bg-slate-950/60 border border-slate-800 rounded-xl p-3.5">
          <div className="flex items-center gap-3 text-xs text-slate-200">
            ...
            <span><strong>Device Gallery:</strong> Select photos, signatures, and stamps</span>
          </div>
          <div className="flex items-center gap-3 text-xs text-slate-200">
            <div className="w-6 h-6 rounded-md bg-sky-500/15 text-sky-400 flex items-center justify-center shrink-0">
              <HardDrive className="w-3.5 h-3.5" />
            </div>
            <span><strong>Device Storage:</strong> Save and download compiled PDF documents</span>
          </div>
        </div>

        <div className="text-[11px] text-slate-400 flex items-center gap-1.5">
          <CheckCircle className="w-3.5 h-3.5 text-emerald-400 shrink-0" />
          <span>This permission is requested once and remembered permanently.</span>
        </div>
